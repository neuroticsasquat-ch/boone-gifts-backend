...
def set_grants_on_create(
    ...
    """Apply the creation-time sharing rule: the list is shared with exactly the
    families asked for, each of which the owner must belong to. An empty list
    shares with nobody — there is no auto-grant."""
